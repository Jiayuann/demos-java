...
import java.net.*;
// 声音播放程序
public class AudioPlay	extends JFrame	implements ActionListener, ItemListener {
	boolean looping = false; //是否循环播放
	String[] choics = { "music.wav", "music2.wav" }; //声音文件名数组
	...
	public static void main(String s[]) {
		new AudioPlay(); //创建AudioPlayDemo对象
	}
}
