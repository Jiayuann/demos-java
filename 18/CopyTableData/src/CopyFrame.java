...
public class CopyFrame extends JFrame {
    ...
    public CopyFrame() {
        ...
        for(int i = 0;i< list.size();i++){
            ...
            ids[i] = stu.getStudentid();
            model.addRow(new Object[]{stu.getStudentid(),stu.getName(),stu.getSex(),stu.getSpecialty(),stu.getGrade()});
        }
    ...
    protected void do_insertButton_actionPerformed(ActionEvent arg0) {
        ...
        JOptionPane.showMessageDialog(getContentPane(), 
                "已经将该生添加到学生信息表2中！", "信息提示框", JOptionPane.WARNING_MESSAGE);
