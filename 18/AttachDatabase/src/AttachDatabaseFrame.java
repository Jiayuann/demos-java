...
public class AttachDatabaseFrame extends JFrame {  
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AttachDatabaseFrame frame = new AttachDatabaseFrame();
    ...
    protected void do_subjoinButton_actionPerformed(ActionEvent arg0) {
        ...
        if ((!namePath.equals("")) && (!dataName.equals(""))
                && (!logFile.equals(""))) {
        	AttachDatabase userDao = new AttachDatabase();
