import java.util.*; 
public class ArtificialDesk extends Object {//客服中心
	private static int nextServiceID = 0;//下一个客服的ID
	private Integer iNIC;//声明网际网络信息中心对象
	private int ServiceID;//客服ID
	private Integer handoffBox;//声明网际网络信息中心对象
	private Thread thread;//声明一个线程对象
	private volatile boolean isStop;//停止服务的标志
	public ArtificialDesk(Integer iNIC) {//构造函数
		this.iNIC = iNIC;
		ServiceID = getNextWorkerID();
		handoffBox = new Integer(1); 
		isStop = true;
