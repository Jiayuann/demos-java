...
public class VoteCount extends JFrame {
    ...
    public VoteCount() {
        ...
        JButton refreshButton = new JButton("Ë¢ÐÂ");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "ÎÒ×îÏ²°®µÄÐ¡Æ·ÑÝÔ±", TitledBorder.LEADING, TitledBorder.TOP, null,
                new Color(59, 59, 59)));
