...
public class TableHeightSet extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TableHeightSet frame = new TableHeightSet();
    ...
    public TableHeightSet() {
        ...
        JLabel label1 = new JLabel("默认表格高度");
        ...
        JLabel label2 = new JLabel("自定义表格高度");
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        ...
        model.setRowCount(0);
        model.setColumnIdentifiers(new Object[] { "2012最新排名", "语言" });
        model.addRow(new Object[] { "1", "C" });
        model.addRow(new Object[] { "2", "Java" });
        model.addRow(new Object[] { "3", "C++" });
        model.addRow(new Object[] { "4", "Objective-C" });
