...
public class CharStatistics extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	CharStatistics frame = new CharStatistics();
    ...
    public CharStatistics() {
        ...
        JLabel label1 = new JLabel("Ñ¡ÖÐµÄ×Ö·ûÊý£º");
        ...
        JLabel label2 = new JLabel("¹â±êËùÔÚ×Ö·û£º");
